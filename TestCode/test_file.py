...
"""
Testing code:
this is testing code of segmentation combination of dr_waqas + watershed code.
...
for image_name in all_images_name:
    ...
    # forground_background_mask = image_thresh_with_divide(image.copy(), 8)
    ...
    # total_cell_count = len(json_object)

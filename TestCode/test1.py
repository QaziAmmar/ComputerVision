...
import cv2
# Directory data
data_dir = path.dataset_path + "IML_training_data/IML_multiclass_classification/p.f_plus_p.v/"
...
# %%
base_train_test_path = path.dataset_path + "IML_training_data/IML_multiclass_train_test_seprerate/p.f_plus_p.v/"
# save train data

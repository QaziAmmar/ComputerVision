...
#%%
load_weights_path = path.save_models_path + "IML_binary_CNN_experimtents/vgg_19_binary_temp/pf_densenet/pf_densnet_binaryClassification.h5"
...
for temp_train_lbl, temp_pred_lbl in zip(binary_test_labels, prediction_labels):
    if temp_train_lbl == "malaria" and temp_pred_lbl == 'healthy':
...
#%%
import cv2
save_new_cell_path = "/home/iml/Desktop/qazi/Model_Result_Dataset/Results/vgg19_binaryCNNResults/p.f_densenet/A=malariaP=healthy/"

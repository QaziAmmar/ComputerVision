...
result_path = path.result_folder_path + "color_consistency/"
...
# cv2.imwrite(result_path + "standard_deviation_weighted_grey_world" + imageName, cca.standard_deviation_weighted_grey_world(img))
...
# cv2.imwrite(result_path + "standard_deviation_weighted_grey_world/" + single_image_name, cca.standard_deviation_weighted_grey_world(img))

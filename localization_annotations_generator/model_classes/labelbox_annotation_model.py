...
#     P_F_PLUS_100_X_CROP = "p.f_plus_100xCrop"
#
#
# class Bbox:
#     top: int
...
#
# class SchemaID(Enum):
#     CKBRTS3_R50_MTT0_Z80_GVU76_ZZF = "ckbrts3r50mtt0z80gvu76zzf"
#     CKBRTS3_R60_MTV0_Z8058_OE04_Y7 = "ckbrts3r60mtv0z8058oe04y7"
#
#
# class Title(Enum):
...
#     P_F_PLUS_100_X_CROP_SEGMENTATION = "p.f_plus_100xCrop Segmentation"
#
#
# class Review:
#     score: int
...
#     view_label: str
#
#     def __init__(self, id: str, data_row_id: str, labeled_data: str, label: Label, created_by: CreatedBy, project_name: ProjectName, created_at: datetime, updated_at: datetime, seconds_to_label: float, external_id: str, agreement: int, benchmark_agreement: int, benchmark_id: None, dataset_name: DatasetName, reviews: List[Review], view_label: str) -> None:
#         self.id = id
...
#
# class ProjectName(Enum):
#     P_VIVAX_100_X_CROP_SEGMENTATION = "P.vivax_100xCrop Segmentation"
#
#
# class Review:
#     score: int

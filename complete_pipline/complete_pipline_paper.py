...
# %%
data_set_base_path = path.dataset_path + "IML_training_data/IML_multiclass_train_test_seprerate/p.f/"
...
print(train_labels[:6], binary_test_labels_enc[:6])
...
binary_load_weights_path = path.save_models_path + "IML_binary_CNN_experimtents/vgg_19_binary_temp/pf_densenet/pf_densnet_binaryClassification.h5"
...
# %%
# load model according to your choice.
model = predefine_models.get_dennet121_transfer_learning(INPUT_SHAPE=INPUT_SHAPE, classes=number_of_classes)

# %%
# This cell shows the accuracy and loss graph and save the model for next time usage.
load_weights_path = path.save_models_path + "IML_binary_CNN_experimtents/vgg_19_binary_temp/pf_densenet/imgNet_with_balance_healthy_pf_densenet_multiclass.h5"
...
# Model Performance Evaluation
basic_cnn_preds = model.predict(cnn_indicated_test_imgs_scaled, batch_size=512)
# # Making prediction lables for multiclass
basic_cnn_preds = basic_cnn_preds.argmax(1)
prediction_labels = le.inverse_transform(basic_cnn_preds)
